...
rule equil_complex_02_npt:
    input:
        ...
        ndx=out_approach_path/"{ligand_name}/input/complex/index.ndx",
        finished=out_approach_path/"{ligand_name}/{replica}/complex/equil-mdsim/01_nvt/01_nvt.finished",
        mdp=out_approach_path/"{ligand_name}/{replica}/complex/equil-mdsim/02_npt/02_npt.mdp",
    params:
        ...
        out_gro=out_approach_path/"{ligand_name}/{replica}/complex/equil-mdsim/02_npt/02_npt.gro",
        out_cpt=out_approach_path/"{ligand_name}/{replica}/complex/equil-mdsim/02_npt/02_npt.cpt",
        run_dir=out_approach_path/"{ligand_name}/{replica}/complex/equil-mdsim/02_npt",
    output:
        finished=out_approach_path/"{ligand_name}/{replica}/complex/equil-mdsim/02_npt/02_npt.finished",
    threads: threads
    retries: retries
    run:
        tools.gmx_runner(
...
rule equil_complex_03_npt:
    ...
    params:
        in_gro=out_approach_path/"{ligand_name}/{replica}/complex/equil-mdsim/02_npt/02_npt.gro",
        in_cpt=out_approach_path/"{ligand_name}/{replica}/complex/equil-mdsim/02_npt/02_npt.cpt",
