...
rule equil_complex_02_nvt:
    ...
    params:
        ...
        output={
            'gro':approach_path + "/{ligand_name}/{replica}/complex/equil-mdsim/02_nvt/02_nvt.gro",
            'cpt':approach_path + "/{ligand_name}/{replica}/complex/equil-mdsim/02_nvt/02_nvt.cpt"
        },
